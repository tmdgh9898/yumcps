...
async function setupDatabase() {
    ...
    await db.exec(`
        CREATE INDEX IF NOT EXISTS idx_prof_case_checks_date_prof
        ON professor_case_checks(date, professor_name)
    `);
    ...
    await ensureColumn(db, 'professor_case_classifications', 'case_count', 'INTEGER DEFAULT 1');
